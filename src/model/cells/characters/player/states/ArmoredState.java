...
public class ArmoredState extends PlayerState implements CellState {
    ...
    public ArmoredState() {
        ...
        this.characterPath = "view/resources/ArmoredHero.PNG";
    ...
    public void move(int x, int y, Maze maze) {
        ...
        if (x == -1) // move left
            this.sprite = new Image("view/resources/LeftArmoredHero.PNG");
        else if (x == 1)  // move right
            this.sprite = new Image("view/resources/ArmoredHero.PNG");
