...
public class UnarmoredState extends PlayerState implements CellState {
    ...
    public UnarmoredState() {
        ...
        this.characterPath = "view/resources/NormalHero.PNG";
    ...
    public void move(int x, int y, Maze maze) {
        ...
        if (x == -1) // move left
            this.sprite = new Image("view/resources/LeftNormalHero.PNG");
        else if (x == 1)  // move right
            this.sprite = new Image("view/resources/NormalHero.PNG");
